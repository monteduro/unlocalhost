...
- Public development routes use `no-store` for shared CDNs and private mandatory revalidation for browser copies. Local routes and unmarked production-like endpoints preserve upstream headers.
